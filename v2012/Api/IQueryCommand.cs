...
namespace Kerosene.ORM.SqlServer.v2012
{
	...
	/// </summary>
	public interface IQueryCommand : Core.IQueryCommand
	{
		/// <summary>
		...
		new IQueryCommand Select(params Func<dynamic, object>[] selects);
		...
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand Distinct(bool distinct = true);
		...
		/// </param>
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand From(params Func<dynamic, object>[] froms);
		...
		/// </param>
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand Where(Func<dynamic, object> where);
		...
		/// </param>
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand Join(Func<dynamic, object> join);
		...
		/// </param>
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand GroupBy(params Func<dynamic, object>[] groupbys);
		...
		/// </param>
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand Having(Func<dynamic, object> having);
		...
		/// </param>
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand OrderBy(params Func<dynamic, object>[] orderbys);
		...
		/// <returns>This instance to permit a fluent syntax chaining.</returns>
		new IQueryCommand Skip(int skip);
